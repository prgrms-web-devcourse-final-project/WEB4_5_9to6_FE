...
export default function SearchBar({
    ...
    return (
        <>
            <div className="mt-[1px] flex h-11 w-full items-center justify-between rounded-[12px] bg-[var(--color-gray200)] px-3 transition-all duration-200 ease-in-out hover:bg-[var(--color-gray300)]">
