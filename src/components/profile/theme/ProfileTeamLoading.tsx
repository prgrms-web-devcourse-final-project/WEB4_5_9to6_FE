        ...
        <>
            <div className="relative mt-0.5 flex h-[50px] w-full items-center justify-center gap-4 px-5">
                ...
                <div className="border-b-gray400 absolute right-5 bottom-0 left-5 border-b">
                    <div className="bg-gray1000 h-[2px] w-[calc(33%-8px)]" />
                </div>
            </div>
                ...
                <div className="mx-5 mb-[90px] grid grid-cols-2 gap-6">
                    <div className="flex animate-pulse flex-col gap-[10px]">
                        <div className="flex items-center gap-1">
                            <div className="bg-gray300 h-4 w-16 rounded" />
                        </div>
                        <div className="bg-gray300 relative aspect-[31/57] w-full overflow-hidden rounded-xl"></div>
                    </div>
                    <div className="flex animate-pulse flex-col gap-[10px]">
                        <div className="flex items-center gap-1">
                            <div className="bg-gray300 h-4 w-16 rounded" />
