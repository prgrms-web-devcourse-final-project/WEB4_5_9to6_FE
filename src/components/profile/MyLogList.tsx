...
export default function MyLogList({ id }: { id: string }) {
    ...
    return (
        <>
            ...
            <div className="bg-gray200 dark:bg-gray1000 h-4 w-full"></div>
            {(data3 || []).length > 0 && (
                <div className="my-6 flex w-full flex-col gap-4">
                    ...
                    <button
                        onClick={openModal}
                        className="bg-gray200 hover:bg-gray300 dark:bg-gray1000 dark:hover:bg-gray900 flex cursor-pointer justify-between rounded-2xl p-5"
                    >
