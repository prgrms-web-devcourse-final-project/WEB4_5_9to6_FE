    ...
    return (
        <>
            ...
            <div className="w-full animate-pulse px-5">
                <h3 className="bg-gray300 mt-6 h-5 w-40 rounded" />
                <div className="mt-[10px] flex flex-col gap-2">
                    <div className="bg-gray300 h-[50px] w-full rounded-xl px-4 py-4" />
                </div>
                <div className="bg-gray100 -mx-5 mt-6 h-4 w-full" />
                <h3 className="bg-gray300 mt-6 h-5 w-32 rounded" />
                <div className="mt-4 space-y-2">
                    {[...Array(4)].map((_, i) => (
                        <div key={i} className="bg-gray300 h-4 w-2/3 rounded" />
                    ))}
                </div>
                <div className="bg-gray100 -mx-5 mt-6 h-4 w-full" />
                <h3 className="bg-gray300 mt-6 h-5 w-24 rounded" />
                <div className="mt-[10px] space-y-2">
                    <div className="bg-gray300 h-4 w-full rounded" />
                    <div className="bg-gray300 h-4 w-4/5 rounded" />
                </div>
            </div>
        </>
    );
