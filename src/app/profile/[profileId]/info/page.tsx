    ...
    return (
        <>
            <div className="flex justify-center">
                <div className="min-h-screen w-90 bg-white pb-4">
                    ...
                    <div className="border-t-gray300 border-b-gray300 mx-5 flex flex-col border-t border-b py-5">
                        <p className="b2 text-gray1000">내 계정</p>
                    </div>
                    <div className="border-b-gray300 mx-5 flex flex-col border-b py-5">
